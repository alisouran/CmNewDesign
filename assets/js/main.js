(function ($) {
    ...
    $(window).on('load', function () {
        ...
        function activate(id){
            $(id).on('click', function(){
                ...
                $(id).addClass("active");
                $("#home22").addClass("active");
            })
            
        }

        scrollToContent("#reg","#regSec");
        scrollToContent("#team","#teamSec");
        scrollToContent("#conductor","#conductorSec");
        scrollToContent("#speaker","#speakerSec");
        scrollToContent("#home","#homeSec");     
        scrollToContent("#contact","#contactSec");
        scrollToContent("#regBtn","#regSec");
        scrollToContent("#regBtn2","#regSec");
        function scrollToContent (id1,id2){
       ...
       function changeBackgroundDesktop(){
        var wp = $('#splashscreen');
        var r = Math.floor((Math.random() * 11) + 1);
        var img = "../cm/assets/img/desktop/image"+r+".jpg";
        console.log(img);
        wp.css({'background-image': 'url('+img+')'});
    }
    ...
    function changeBackgroundMobile(){
        ...
        var img = "../cm/assets/img/mobile/image"+r+".jpg";
        console.log(img);
        wp.css({'background-image': 'url('+img+')'});
    }
